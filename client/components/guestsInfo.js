        ...
        <div id="guests-info-container2">
          <div className="guests-info-section">
            ...
            <div className="guests-buttons">
              <button type="button" className="plus-minus-button"><span><svg viewBox="0 0 24 24" role="img" aria-label="subtract"><rect height="2" rx="1" width="12" x="6" y="11" /></svg></span></button>
              <span className="num-guests">1</span>
              <button className="plus-minus-button" type="button">
                <span>
